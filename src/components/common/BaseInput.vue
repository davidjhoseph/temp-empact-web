<template>
	...
	<div v-if="description" class="text-caption description text-gray-60">{{ description }}</div>
	<div class="relative inline-block w-full">
		<div v-if="icon" class="absolute top-0 bottom-0 left-0 my-auto flex h-full items-center rounded-r-lg px-2">
			<slot name="icon"/>
		</div>
		<input
			v-if="type !== 'date'"
