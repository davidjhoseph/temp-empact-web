<template>
  <button
    ...
    type="button"
    class="relative inline-flex items-center text-caption justify-center px-1.5 md:px-3 py-2 font-medium border border-transparent rounded-md text-body focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:bg-gray-40"
    :class="[styles]"
  >
    <slot></slot>
